...
(function () {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$7, 44, 0, 1014);
    			add_location(button, file$7, 45, 0, 1065);
    		},
    		m: function mount(target, anchor) {
    			mount_component(link, target, anchor);
    ...
    // (17:0) {#if googleService.mapLoaded}
    function create_if_block$6(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(17:0) {#if googleService.mapLoaded}",
    		ctx
    	});
    ...
    function create_fragment$a(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*googleService*/ ctx[0].mapLoaded && create_if_block$6(ctx);

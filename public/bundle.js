...
(function () {
    ...
    function create_catch_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(p, file$3, 63, 12, 2728);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_then_block(ctx) {
    	...
    	let t4;
    	let div3;
    	let t5_value = /*profile*/ ctx[3].name + "";
    	let t5;
    	let t6;
    	let div7;
    	let div5;
    	...
    	let t8;
    	let div6;
    	let t9_value = /*profile*/ ctx[3].surname + "";
    	let t9;
    	let t10;
    	let div10;
    	let div8;
    	...
    	let t12;
    	let div9;
    	let t13_value = /*profile*/ ctx[3].email + "";
    	let t13;
    	let t14;
    	let div13;
    	let div11;
    	...
    	let t16;
    	let div12;
    	let t17_value = /*profile*/ ctx[3].age + "";
    	let t17;
    	let t18;
    	let div16;
    	let div14;
    	...
    	let t20;
    	let div15;
    	let t21_value = /*profile*/ ctx[3].phone + "";
    	let t21;
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(img, file$3, 33, 16, 1532);
    			attr_dev(div0, "class", "text-center");
    			add_location(div0, file$3, 32, 12, 1490);
    			attr_dev(div1, "class", "col-md-3");
    			add_location(div1, file$3, 31, 12, 1455);
    			add_location(h3, file$3, 39, 16, 1756);
    			attr_dev(div2, "class", "col-lg-2");
    			add_location(div2, file$3, 41, 20, 1833);
    			attr_dev(div3, "class", "col-lg-6");
    			add_location(div3, file$3, 42, 20, 1893);
    			attr_dev(div4, "class", "row");
    			add_location(div4, file$3, 40, 16, 1795);
    			attr_dev(div5, "class", "col-lg-2");
    			add_location(div5, file$3, 45, 20, 2013);
    			attr_dev(div6, "class", "col-lg-6");
    			add_location(div6, file$3, 46, 20, 2072);
    			attr_dev(div7, "class", "row");
    			add_location(div7, file$3, 44, 16, 1975);
    			attr_dev(div8, "class", "col-lg-2");
    			add_location(div8, file$3, 49, 20, 2195);
    			attr_dev(div9, "class", "col-lg-6");
    			add_location(div9, file$3, 50, 20, 2250);
    			attr_dev(div10, "class", "row");
    			add_location(div10, file$3, 48, 16, 2157);
    			attr_dev(div11, "class", "col-lg-2");
    			add_location(div11, file$3, 53, 20, 2371);
    			attr_dev(div12, "class", "col-lg-6");
    			add_location(div12, file$3, 54, 20, 2424);
    			attr_dev(div13, "class", "row");
    			add_location(div13, file$3, 52, 16, 2333);
    			attr_dev(div14, "class", "col-lg-2");
    			add_location(div14, file$3, 57, 20, 2543);
    			attr_dev(div15, "class", "col-lg-6");
    			add_location(div15, file$3, 58, 20, 2598);
    			attr_dev(div16, "class", "row");
    			add_location(div16, file$3, 56, 16, 2505);
    			attr_dev(div17, "class", "col-md-9 personal-info");
    			add_location(div17, file$3, 38, 12, 1703);
    		},
    		m: function mount(target, anchor) {
    ...
    // (28:59)              <img src="/gifs/spinner.gif" alt="" style="margin: auto">         {:then profile}
    function create_pending_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(img, file$3, 28, 12, 1328);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(28:59)              <img src=\\\"/gifs/spinner.gif\\\" alt=\\\"\\\" style=\\\"margin: auto\\\">         {:then profile}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	handle_promise(promise = /*profileService*/ ctx[1].getUserProfile(/*authService*/ ctx[0]), info);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(h1, file$3, 24, 4, 1208);
    			add_location(hr, file$3, 25, 4, 1229);
    			attr_dev(div0, "class", "row");
    			add_location(div0, file$3, 26, 4, 1238);
    			attr_dev(div1, "class", "container");
    			add_location(div1, file$3, 23, 0, 1180);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, h1);
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(span, file$8, 78, 16, 4381);
    			attr_dev(li, "class", "nav-item");
    			add_location(li, file$8, 77, 12, 4343);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(77:8) {#each currRoutes as route}",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(path9, file$8, 69, 959, 2315);
    			...
    			add_location(path10, file$8, 69, 1164, 2520);
    			...
    			add_location(path11, file$8, 69, 1439, 2795);
    			...
    			add_location(path14, file$8, 69, 2017, 3373);
    			...
    			add_location(path15, file$8, 69, 2300, 3656);
    			attr_dev(path16, "d", "m53 26v-2c0-1.103-.897-2-2-2s-2 .897-2 2v2c0 1.103.897 2 2 2s2-.897 2-2z");
    			add_location(path16, file$8, 69, 2505, 3861);
    			add_location(g, file$8, 69, 185, 1541);
    			...
    			add_location(svg, file$8, 69, 6, 1362);
    			attr_dev(span0, "class", "navbar-brand");
    			add_location(span0, file$8, 68, 4, 1295);
    			attr_dev(span1, "class", "navbar-toggler-icon");
    			add_location(span1, file$8, 72, 6, 4151);

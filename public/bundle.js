...
(function () {
    ...
    function create_if_block_1$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(div, file$5, 103, 6, 2271);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(103:4) {#if destination !== '' && !clicked}",
    		ctx
    	});
    ...
    // (105:8) {#each predictions as prediction}
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			input.readOnly = true;
    			add_location(input, file$5, 105, 10, 2331);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(105:8) {#each predictions as prediction}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	let if_block1 = /*destination*/ ctx[1] === "" && create_if_block$4(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(label0, file$5, 91, 6, 1915);
    			attr_dev(input0, "type", "search");
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "placeholder", input0_placeholder_value = /*fromUni*/ ctx[0] ? "To" : "From");
    			add_location(input0, file$5, 92, 6, 1963);
    			attr_dev(div0, "class", "form-group");
    			add_location(div0, file$5, 90, 4, 1883);
    			add_location(div1, file$5, 117, 4, 2624);
    			add_location(label1, file$5, 123, 6, 2767);
    			attr_dev(input1, "type", "time");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "placeholder", "From");
    			add_location(input1, file$5, 124, 6, 2794);
    			attr_dev(div2, "class", "form-group");
    			add_location(div2, file$5, 122, 4, 2735);
    			add_location(label2, file$5, 131, 6, 2964);
    			attr_dev(input2, "type", "time");
    			attr_dev(input2, "class", "form-control");
    			attr_dev(input2, "placeholder", "To");
    			add_location(input2, file$5, 132, 6, 2989);
    			attr_dev(div3, "class", "form-group");
    			add_location(div3, file$5, 130, 4, 2932);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$5, 139, 6, 3151);
    			attr_dev(div4, "class", "action svelte-rnsfl4");
    			add_location(div4, file$5, 138, 4, 3123);
    			attr_dev(form, "class", "svelte-rnsfl4");
    			add_location(form, file$5, 89, 2, 1871);
    			attr_dev(div5, "class", "wrapper svelte-rnsfl4");
    			add_location(div5, file$5, 88, 0, 1846);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("seats" in $$props) $$invalidate(15, seats = $$props.seats);
    ...
    function create_if_block_1$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(div, file$6, 97, 6, 2121);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(97:4) {#if destination !== '' && !clicked}",
    		ctx
    	});
    ...
    // (99:8) {#each predictions as prediction}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			input.readOnly = true;
    			add_location(input, file$6, 99, 10, 2181);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(99:8) {#each predictions as prediction}",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	let if_block1 = /*destination*/ ctx[1] === "" && create_if_block$5(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(label0, file$6, 85, 6, 1765);
    			attr_dev(input0, "type", "search");
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "placeholder", input0_placeholder_value = /*fromUni*/ ctx[0] ? "To" : "From");
    			add_location(input0, file$6, 86, 6, 1813);
    			attr_dev(div0, "class", "form-group");
    			add_location(div0, file$6, 84, 4, 1733);
    			add_location(div1, file$6, 111, 4, 2474);
    			add_location(label1, file$6, 117, 6, 2617);
    			attr_dev(input1, "type", "time");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "placeholder", "Time");
    			add_location(input1, file$6, 118, 6, 2644);
    			attr_dev(div2, "class", "form-group");
    			add_location(div2, file$6, 116, 4, 2585);
    			add_location(label2, file$6, 125, 6, 2809);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "class", "form-control");
    			attr_dev(input2, "placeholder", "Number of Seats");
    			add_location(input2, file$6, 126, 6, 2847);
    			attr_dev(div3, "class", "form-group");
    			add_location(div3, file$6, 124, 4, 2777);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$6, 133, 6, 3022);
    			attr_dev(div4, "class", "action svelte-rnsfl4");
    			add_location(div4, file$6, 132, 4, 2994);
    			attr_dev(form, "class", "svelte-rnsfl4");
    			add_location(form, file$6, 83, 2, 1721);
    			attr_dev(div5, "class", "wrapper svelte-rnsfl4");
    			add_location(div5, file$6, 82, 0, 1696);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div5, anchor);
    			append_dev(div5, form);
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$7, 44, 0, 1013);
    			add_location(button, file$7, 45, 0, 1064);
    		},
    		m: function mount(target, anchor) {
    			mount_component(link, target, anchor);
    ...
    const file$8 = "src\\routes\\MapApp.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	let if_block_anchor;
    	let current;
    	let if_block = /*ready*/ ctx[0] && create_if_block$6(ctx);
    	...
    	const block = {
    		...
    		l: function claim(nodes) {
    			const head_nodes = query_selector_all("[data-svelte=\"svelte-12bc0dh\"]", document.head);
    			script = claim_element(head_nodes, "SCRIPT", { defer: true, async: true, src: true });
    		...
    		h: function hydrate() {
    			script.defer = true;
    			script.async = true;
    			if (script.src !== (script_src_value = "https://maps.googleapis.com/maps/api/js?key=AIzaSyCAqZrL_-ZKPZ4q4gd_ct4SsLB39md6dd0&callback=initMap")) attr_dev(script, "src", script_src_value);
    			add_location(script, file$8, 19, 2, 337);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ DeviceDetectorService, Map: Map$1, ready });

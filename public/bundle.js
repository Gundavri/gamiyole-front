...
(function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(span, file$3, 29, 4, 1180);
    			attr_dev(div, "class", "svelte-v5ji3m");
    			add_location(div, file$3, 27, 0, 1155);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(div, file$5, 105, 6, 2687);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(105:4) {#if destination !== '' && !clicked}",
    		ctx
    	});
    ...
    // (107:8) {#each predictions as prediction}
    function create_each_block(ctx) {
    	...
    	function click_handler(...args) {
    		return /*click_handler*/ ctx[10](/*prediction*/ ctx[18], ...args);
    	}
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			input.readOnly = true;
    			add_location(input, file$5, 107, 10, 2747);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(107:8) {#each predictions as prediction}",
    		ctx
    	});
    ...
    // (124:8) <Link to="/map?destination={destination}&startTime={startTime}&endTime={endTime}">
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(124:8) <Link to=\\\"/map?destination={destination}&startTime={startTime}&endTime={endTime}\\\">",
    		ctx
    	});
    ...
    // (122:8) <Link to="/map?startTime={startTime}&endTime={endTime}">
    function create_default_slot$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(122:8) <Link to=\\\"/map?startTime={startTime}&endTime={endTime}\\\">",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(label0, file$5, 93, 6, 2331);
    			attr_dev(input0, "type", "search");
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "placeholder", input0_placeholder_value = /*fromUni*/ ctx[0] ? "To" : "From");
    			add_location(input0, file$5, 94, 6, 2379);
    			attr_dev(div0, "class", "form-group");
    			add_location(div0, file$5, 92, 4, 2299);
    			add_location(div1, file$5, 119, 4, 3040);
    			add_location(label1, file$5, 127, 6, 3351);
    			attr_dev(input1, "type", "time");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "placeholder", "From");
    			add_location(input1, file$5, 128, 6, 3378);
    			attr_dev(div2, "class", "form-group");
    			add_location(div2, file$5, 126, 4, 3319);
    			add_location(label2, file$5, 135, 6, 3548);
    			attr_dev(input2, "type", "time");
    			attr_dev(input2, "class", "form-control");
    			attr_dev(input2, "placeholder", "To");
    			add_location(input2, file$5, 136, 6, 3573);
    			attr_dev(div3, "class", "form-group");
    			add_location(div3, file$5, 134, 4, 3516);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$5, 143, 6, 3735);
    			attr_dev(div4, "class", "action svelte-rnsfl4");
    			add_location(div4, file$5, 142, 4, 3707);
    			attr_dev(form, "class", "svelte-rnsfl4");
    			add_location(form, file$5, 91, 2, 2287);
    			attr_dev(div5, "class", "wrapper svelte-rnsfl4");
    			add_location(div5, file$5, 90, 0, 2262);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*onSubmit*/ ctx[6], false, false, false)
    				];
    ...
    function create_if_block_1$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(div, file$6, 105, 6, 2483);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_each_block$1(ctx) {
    	...
    	function click_handler(...args) {
    		return /*click_handler*/ ctx[10](/*prediction*/ ctx[17], ...args);
    	}
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			input.readOnly = true;
    			add_location(input, file$6, 107, 10, 2543);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    ...
    // (124:8) <Link to="/map?destination={destination}&time={time}&seats={seats}">
    function create_default_slot_1$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(124:8) <Link to=\\\"/map?destination={destination}&time={time}&seats={seats}\\\">",
    		ctx
    	});
    ...
    // (122:8) <Link to="/map?time={time}&seats={seats}">
    function create_default_slot$4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(122:8) <Link to=\\\"/map?time={time}&seats={seats}\\\">",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(label0, file$6, 93, 6, 2125);
    			attr_dev(input0, "type", "search");
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "placeholder", input0_placeholder_value = /*fromUni*/ ctx[0] ? "To" : "From");
    			add_location(input0, file$6, 94, 6, 2173);
    			attr_dev(div0, "class", "form-group");
    			add_location(div0, file$6, 92, 4, 2093);
    			add_location(div1, file$6, 119, 4, 2838);
    			add_location(label1, file$6, 127, 6, 3119);
    			attr_dev(input1, "type", "time");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "placeholder", "Time");
    			add_location(input1, file$6, 128, 6, 3146);
    			attr_dev(div2, "class", "form-group");
    			add_location(div2, file$6, 126, 4, 3087);
    			add_location(label2, file$6, 135, 6, 3311);
    			attr_dev(input2, "type", "number");
    			attr_dev(input2, "class", "form-control");
    			attr_dev(input2, "placeholder", "Number of Seats");
    			add_location(input2, file$6, 136, 6, 3349);
    			attr_dev(div3, "class", "form-group");
    			add_location(div3, file$6, 134, 4, 3279);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$6, 143, 6, 3524);
    			attr_dev(div4, "class", "action svelte-rnsfl4");
    			add_location(div4, file$6, 142, 4, 3496);
    			attr_dev(form, "class", "svelte-rnsfl4");
    			add_location(form, file$6, 91, 2, 2081);
    			attr_dev(div5, "class", "wrapper svelte-rnsfl4");
    			add_location(div5, file$6, 90, 0, 2056);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div5, anchor);
    			append_dev(div5, form);
    ...
    const file$8 = "src\\components\\MapForRoutes.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div, "class", "full-screen svelte-13oovha");
    			add_location(div, file$8, 69, 0, 2059);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["startLocation", "endLocation", "gamiyole"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$3.warn(`<MapForRoutes> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("MapForRoutes", $$slots, []);
    	...
    	$$self.$set = $$props => {
    		if ("startLocation" in $$props) $$invalidate(1, startLocation = $$props.startLocation);
    		if ("endLocation" in $$props) $$invalidate(2, endLocation = $$props.endLocation);
    		if ("gamiyole" in $$props) $$invalidate(3, gamiyole = $$props.gamiyole);
    	};
    	...
    	return [container, startLocation, endLocation, gamiyole, div_binding];
    }

    class MapForRoutes extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*gamiyole*/ ctx[3] === undefined && !("gamiyole" in props)) {
    			console_1$3.warn("<MapForRoutes> was created without expected prop 'gamiyole'");
    		}
    	}

    	get startLocation() {
    		throw new Error("<MapForRoutes>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set startLocation(value) {
    		throw new Error("<MapForRoutes>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    const file$9 = "src\\routes\\WaitingRoom.svelte";
    ...
    function create_if_block$7(ctx) {
    	...
    	mapforroutes = new MapForRoutes({
    			props: {
    				class: "map",
    				startLocation: "აგრარული უნივერსიტეტი (ეკლესია), D. Aghmashenebeli Ave, T'bilisi, Georgia",
    				endLocation: /*destination*/ ctx[0],
    				gamiyole: /*gamiyole*/ ctx[1]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			create_component(mapforroutes.$$.fragment);
    		},
    		l: function claim(nodes) {
    			claim_component(mapforroutes.$$.fragment, nodes);
    		},
    		m: function mount(target, anchor) {
    			mount_component(mapforroutes, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const mapforroutes_changes = {};
    			if (dirty & /*destination*/ 1) mapforroutes_changes.endLocation = /*destination*/ ctx[0];
    			if (dirty & /*gamiyole*/ 2) mapforroutes_changes.gamiyole = /*gamiyole*/ ctx[1];
    			mapforroutes.$set(mapforroutes_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(mapforroutes.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(mapforroutes.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(mapforroutes, detaching);
    		}
    	};
    ...
    function create_fragment$c(ctx) {
    	...
    	let br4;
    	let current;
    	let if_block = /*isInitMap*/ ctx[2] && create_if_block$7(ctx);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(div0, "class", "map svelte-3keruk");
    			add_location(div0, file$9, 99, 2, 2229);
    			add_location(br0, file$9, 105, 6, 2496);
    			add_location(br1, file$9, 106, 6, 2508);
    			add_location(br2, file$9, 108, 6, 2526);
    			add_location(br3, file$9, 110, 6, 2544);
    			add_location(br4, file$9, 112, 6, 2562);
    			attr_dev(div1, "class", "suggestions svelte-3keruk");
    			add_location(div1, file$9, 104, 2, 2463);
    			attr_dev(div2, "class", "wrapper svelte-3keruk");
    			add_location(div2, file$9, 98, 0, 2204);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	if (DeviceDetectorService.isBrowser) {
    		for (let i = 0; i < 10; i++) {
    			setTimeout(
    				() => {
    					$$invalidate(2, isInitMap = window.isInitMap);
    				},
    				i * 100
    			);
    		}
    	...
    	onMount(() => {
    		...
    		$$invalidate(1, gamiyole = params.get("gamiyole") === "true");
    		$$invalidate(0, destination = params.get("destination"));
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<WaitingRoom> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("WaitingRoom", $$slots, []);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("gamiyole" in $$props) $$invalidate(1, gamiyole = $$props.gamiyole);
    		if ("isInitMap" in $$props) $$invalidate(2, isInitMap = $$props.isInitMap);
    	};
    	...
    	return [destination, gamiyole, isInitMap];
    }

    class WaitingRoom extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_default_slot$5(ctx) {
    	...
    	route7 = new Route({
    			props: { path: "wait", component: WaitingRoom },
    			$$inline: true
    		});
